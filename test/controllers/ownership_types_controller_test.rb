...
class OwnershipTypesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create ownership_type" do
    assert_difference("OwnershipType.count") do
      post ownership_types_url, params: { ownership_type: { description: @ownership_type.description, name: @ownership_type.name } }, as: :json
    end
  ...
  test "should update ownership_type" do
    patch ownership_type_url(@ownership_type), params: { ownership_type: { description: @ownership_type.description, name: @ownership_type.name } }, as: :json
    assert_response :success
  end
